...
//        Log.i(TAG,"onLayout");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        arcRectF.set(VIEW_WIDTH / 2f - (radius+5), VIEW_HEIGHT / 2f - (radius+5), VIEW_WIDTH / 2f + (radius+5), VIEW_HEIGHT / 2f + (radius+5));

        canvas.drawArc(arcRectF, -90f, 300f, false, circlepaint);

        circlepaint.setStrokeWidth(8f);

        circlepaint.setAlpha(100);

        canvas.drawArc(arcRectF, 213.5f, 0.1f, false, circlepaint);
