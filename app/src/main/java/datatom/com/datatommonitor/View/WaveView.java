...
public class WaveView extends View {
     ...
     */
    public  static float SPEED_SLOW = 20f; // Slow speed
...
//            reiseAnimator.cancel();//不应该取消，应该让其直接结束
    ...
    private void rerefreshPoints(){
        ...
        WAVE_HEIGHT = VIEW_HEIGHT/getWaveHeight()+15;
...
//        Log.i(TAG,"onLayout");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        arcRectF.set(centerX - (radius+5), centerY - (radius+5), centerX + (radius+5), centerY + (radius+5));

        canvas.drawArc(arcRectF, startangle, 300f, false, circlepaint);
...
//        Log.d("yuan"," onWindowFocusChanged " + isDone);
    ...
    private void flowingAnimation(){
        ...
        Circleanimator = ObjectAnimator.ofFloat(this,"startangle",0f,360f);
