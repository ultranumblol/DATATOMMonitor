...
public abstract class MyRecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    protected List<T> mObjects;
    protected MyEventDelegate mEventDelegate;
    protected ArrayList<ItemView> headers = new ArrayList<>();
    protected ArrayList<ItemView> footers = new ArrayList<>();

    protected MyRecyclerArrayAdapter.OnItemClickListener mItemClickListener;
    protected MyRecyclerArrayAdapter.OnItemLongClickListener mItemLongClickListener;
    ...
    public MyRecyclerArrayAdapter.GridSpanSizeLookup obtainGridSpanSizeLookUp(int maxCount){
        return new MyRecyclerArrayAdapter.GridSpanSizeLookup(maxCount);
    }
     ...
     */
    public MyRecyclerArrayAdapter(Context context, T[] objects) {
     ...
     * @param objects The objects to represent in the ListView.
     */
    public MyRecyclerArrayAdapter(Context context, List<T> objects) {
    ...
    public void addHeader(MyRecyclerArrayAdapter.ItemView view){
        if (view==null)throw new NullPointerException("ItemView can't be null");
        headers.add(view);
        notifyItemInserted(footers.size()-1);
    }

    public void addFooter(MyRecyclerArrayAdapter.ItemView view){
        if (view==null)throw new NullPointerException("ItemView can't be null");
        footers.add(view);
    ...
    public MyRecyclerArrayAdapter.ItemView getHeader(int index){
        return headers.get(index);
    }

    public MyRecyclerArrayAdapter.ItemView getFooter(int index){
    ...
    public void removeHeader(MyRecyclerArrayAdapter.ItemView view){
        int position = headers.indexOf(view);
        headers.remove(view);
        notifyItemRemoved(position);
    }

    public void removeFooter(MyRecyclerArrayAdapter.ItemView view){
    ...
    MyEventDelegate getEventDelegate(){
        if (mEventDelegate == null)mEventDelegate  = new MyDefaultEventDelegate(this);
        return mEventDelegate;
    }

    public View setMore(final int res, final MyRecyclerArrayAdapter.OnLoadMoreListener listener){
    ...
    public View setMore(final View view, MyRecyclerArrayAdapter.OnLoadMoreListener listener){
    ...
    private View createSpViewByType(ViewGroup parent, int viewType){
        for (MyRecyclerArrayAdapter.ItemView headerView:headers){
        ...
        for (MyRecyclerArrayAdapter.ItemView footerview:footers){
    ...
    public final BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (view!=null){
            return new MyRecyclerArrayAdapter.StateViewHolder(view);
        }
        ...
        if (mItemClickListener!=null) {
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mItemClickListener.onItemClick(viewHolder.getAdapterPosition()-headers.size(),viewHolder.itemView);
                }
            });
        }
        ...
        if (mItemLongClickListener!=null){
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return mItemLongClickListener.onItemLongClick(viewHolder.getAdapterPosition()-headers.size(),viewHolder.itemView);
                }
            });
        }
        return viewHolder;
    ...
    public void setOnItemClickListener(MyRecyclerArrayAdapter.OnItemClickListener listener){
        this.mItemClickListener = listener;
    }

    public void setOnItemLongClickListener(MyRecyclerArrayAdapter.OnItemLongClickListener listener){
