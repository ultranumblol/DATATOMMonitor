...
public class MyDefaultEventDelegate implements MyEventDelegate {
    private MyRecyclerArrayAdapter adapter;
    private MyDefaultEventDelegate.EventFooter footer ;

    private MyRecyclerArrayAdapter.OnLoadMoreListener onLoadMoreListener;
    ...
    public MyDefaultEventDelegate(MyRecyclerArrayAdapter adapter) {
    ...
    @Override
    public void setMore(View view, MyRecyclerArrayAdapter.OnLoadMoreListener listener) {
    ...
    private class EventFooter implements MyRecyclerArrayAdapter.ItemView {
